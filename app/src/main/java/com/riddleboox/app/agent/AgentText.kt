 ...
 * through the "export" action in [com.riddleboox.app.AgentsActivity] — same
 ...
 * an empty "Description:" line, the same reasoning [com.riddleboox.app.history.StoredTurn.toPlainText]
