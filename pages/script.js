  ...
  const stages = [
    {
      state: 'write',
      turn: 1,
      status: 'ready for ink',
      caption: 'write a request with the pen',
      lines: ['Where did I stop', 'in my current book?'],
      duration: 3200,
    },
    {
      state: 'dissolve',
      turn: 1,
      status: 'sending page',
      caption: 'the page becomes the request',
      lines: ['Where did I stop', 'in my current book?'],
      duration: 1100,
    },
    {
      state: 'think',
      turn: 1,
      status: 'checking library',
      caption: 'using an enabled BOOX tool',
      lines: [],
      duration: 1900,
    },
    {
      ...
      turn: 1,
      status: 'writing back',
      caption: 'answer rendered in ink',
      lines: ['You last stopped', 'at chapter six.'],
      duration: 3600,
    },
    {
      state: 'write',
      turn: 2,
      status: 'ready for ink',
      caption: 'write the follow-up',
      lines: ['What did I highlight', 'near that point?'],
      duration: 3200,
    },
    {
      state: 'dissolve',
    ...
    },
    {
      state: 'think',
      turn: 2,
      status: 'checking highlights',
      caption: 'using the earlier turn as context',
      lines: [],
      duration: 1900,
    },
    {
      ...
      status: 'writing back',
      caption: 'answer rendered in ink',
      lines: ['You highlighted a passage', 'about careful attention.'],
      duration: 3600,
    },
  ];
